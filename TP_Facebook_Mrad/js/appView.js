 var AppView          = Backbone.View.extend({
	...
	search: function(e){
		...
		this.friends.setCounts(e.currentTarget.value); // La recherche déclenche la mise à jour des statistiques sur la collection filtrée, les graphiques sont mis à jour en conséquence
		this.drawCharts();
	...
	/** Actualisation des graphiques (la mise à jour se fait dans le modèle) */
	drawCharts: function(){ 
	 ...
	 /** Créer les différents graphiques pour les statistiques (une fonction par graphique Google , à améliorer en 1 seule fonction prenant en param les stats à évaluer) */
	 /* Sexe */
	 drawChartGender: function() {        
	  ...
	  /* Personnes ayant une date d'anniversaire (ou non) */
	 ...
	 /* Nombre d'amis par tranches ( plus de 500, entre 100 et 500, moins de 100) */
	 ...
	 /* Statut (en couple, célibataire, non précisé  (ne prend pas en compte les autres types de relations : partenariat domestique, relation libre ... )*/
